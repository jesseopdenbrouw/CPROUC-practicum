...
\lstset{%
  ...
  %moredelim=[s][\textcolor{character}]{<}{>},
  %% Control keywords
  deletekeywords={int,char,void,double,static,const,unsigned,signed,volatile},
  keywordstyle=\color{controlkeyword},
  %% Declaration keywords
  keywords=[2]{int,char,void,double,static,const,unsigned,signed,volatile},
  keywordstyle=[2]{\color{otherkeyword}},
  %% Trick: functions
  keywords=[3]{scanf,printf,getchar,sqrt,pow,main,fib,leesCijfer,fflush,exit,malloc,free,realloc,catalan,faculteit,catalanRecursief,collatzSteps,max2,leesGetal,gemiddelde,kgv,ggd,leesEnBerekenSom,leesEnBerekenMod9,isprime,isisolatedprime,sinc,aantal_delers,reverse,strrev,is_palindroom,controleerNedEuroID,doorsnede,uniek,rlecompress,roll_dice,rand,stringreplace,scanf_s,getoneline},
  keywordstyle=[3]{\color{function}},
  %% Trick: header files, the < and > are not colorized
  alsoletter={.},
  keywords=[4]{stdio.h,math.h,malloc.h,string.h},
  keywordstyle=[4]{\color{string}},
  %% Trick: preprocessor commands
  literate=*{\#include}{{\textcolor{preprocessor}{\#include}}}7
            {\#define}{{\textcolor{preprocessor}{\#define}}}6
            {\#undef}{{\textcolor{preprocessor}{\#undef}}}5
            {\#ifdef}{{\textcolor{preprocessor}{\#ifdef}}}5
            {\#ifndef}{{\textcolor{preprocessor}{\#ifndef}}}6
            {\#else}{{\textcolor{preprocessor}{\#else}}}4
            {\#elif}{{\textcolor{preprocessor}{\#elif}}}4
            {\#endif}{{\textcolor{preprocessor}{\#endif}}}5
            {\#pragma}{{\textcolor{preprocessor}{\#pragma}}}6
            {\#error}{{\textcolor{preprocessor}{\#error}}}5
            {\#if}{{\textcolor{preprocessor}{\#if}}}2,
  %% Comments
...
Voer de handelingen uit in bijlage~\ref{sec:installatievsc}.
