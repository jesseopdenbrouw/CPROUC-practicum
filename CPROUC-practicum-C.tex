...
\begin{lstlisting}[style=,literate=]
...
\subsection{Aantal ingevoerde cijfers afdrukken}
...
\subsection{Nulpunten van een functie bepalen}
...
\subsection{Afstand tussen twee punten}
Gegeven zijn twee punten in een 2-dimensionaal vlak. De punten worden gegeven via twee structures:
...
\subsection{Array afdrukken}
Schrijf een programma dat een array van tien integers met behulp van een pointer afdrukt.

\subsection{String achterstevoren afdrukken}
...
\subsection{Array van integers omkeren}
...
\subsection{Zoek het grootste getal}
...
\subsection{Vervangen van karakter}
Schrijf een functie die in een meegegeven string, het meegegeven karakter vervangt door een tweede meegegeven karakter. Gebruik in deze functie pointers. Test de functie met een hoofdprogramma.


\subsection{Vervangen van woord}
