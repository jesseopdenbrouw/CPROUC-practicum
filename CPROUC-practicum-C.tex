...
%  prebreak=\mbox{\textcolor{red}{$\hookleftarrow$}\space},
  ...
  deletekeywords={int,char,void,double,static,const,unsigned,signed,volatile,auto,extern,typedef,enum,long,struct,short},
  keywordstyle=\color{controlkeyword},
  %% Declaration keywords
  keywords=[2]{int,char,void,double,static,const,unsigned,signed,volatile,auto,extern,typedef,enum,long,struct,short},
